...
Règles :
- Pour chaque événement : nom, ville, date si disponible, lien exact (ne modifie pas les URLs)
...
Правила:
- Для каждого события: название, город, дата если есть, точная ссылка (не меняй URL)
