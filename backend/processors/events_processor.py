...
- Sélectionne 4-6 événements en priorité : concerts, spectacles, événements culturels, gastronomie, festivals, sorties en famille. Évite les meetups tech/business sauf si exceptionnel.
- OBLIGATOIRE : inclus au moins 1 événement dont la source est "Meetup" ou "Eventbrite" (pas uniquement Secret Tel Aviv).
...
- Выбери 4-6 событий в приоритете : концерты, спектакли, культурные мероприятия, гастрономия, фестивали, семейный досуг. Избегай tech/бизнес-митапов если только не исключительное событие.
- ОБЯЗАТЕЛЬНО : включи минимум 1 событие с источником "Meetup" или "Eventbrite" (не только Secret Tel Aviv).
