...
Rédige UN message WhatsApp en français en suivant EXACTEMENT cette structure :

🎉 Les événements de la semaine — par Alia

[2-3 événements culturels/concerts/gastronomie avec lien exact]

👨‍👩‍👧 Pour les familles
[1-2 événements adaptés aux enfants ou familles avec lien exact — cherche dans les sources "Mairie de Tel Aviv" ou tout événement familial]

[1 événement Meetup ou Eventbrite avec lien exact]

💬 Parle à Alia 👉 https://wa.me/972549675013?text=Avant%20de%20commencer%2C%20pr%C3%A9sente-toi.

Règles :
- Pour chaque événement : nom, ville, date/heure (OBLIGATOIRE si fournie), lien exact (ne modifie pas les URLs)
- La section "👨‍👩‍👧 Pour les familles" est OBLIGATOIRE même si tu dois chercher un événement famille parmi tous les disponibles
- Ton chaleureux, 150-200 mots au total
...
Напиши сообщение для WhatsApp на русском, следуя ТОЧНО этой структуре:

🎉 События недели — от Alia

[2-3 культурных события/концерты/гастрономия с точной ссылкой]

👨‍👩‍👧 Для семей
[1-2 события для детей или семей с точной ссылкой — ищи в источнике "Mairie de Tel Aviv" или любые семейные события]

[1 событие из Meetup или Eventbrite с точной ссылкой]

💬 Напиши Alia 👉 https://wa.me/972549675013?text=%D0%9F%D1%80%D0%B5%D0%B4%D1%81%D1%82%D0%B0%D0%B2%D1%8C%D1%81%D1%8F.

Правила:
- Для каждого события: название, город, дата/время (ОБЯЗАТЕЛЬНО если указана), точная ссылка (не меняй URL)
- Раздел "👨‍👩‍👧 Для семей" ОБЯЗАТЕЛЕН даже если нужно поискать среди всех доступных событий
- Тёплый тон, 150-200 слов всего
