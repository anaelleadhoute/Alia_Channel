...
Rédige un résumé des infos du jour en français (150-200 mots) destiné aux olim.
- Commence par : 📰 *Les infos du jour — {today}*
- Liste les 3-5 points les plus importants à retenir avec des puces (•)
...
Напиши сводку новостей дня на русском (150-200 слов) для олим.
- Начни с : 📰 *Новости дня — {today}*
- Перечисли 3-5 самых важных пунктов с маркерами (•)
