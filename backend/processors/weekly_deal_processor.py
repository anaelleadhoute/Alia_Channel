...
COMBINED_FR_PROMPT = """Tu es rédacteur pour Alia Channel, média pour les olim francophones en Israël.
...
COMBINED_RU_PROMPT = """Ты редактор Alia Channel — медиа для русскоязычных олим в Израиле.
