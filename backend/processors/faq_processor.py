...
ALIA_LINK_RU = "https://wa.me/972549675013?text=Помоги"
...
Format EXACT (sans réponses, sans rien ajouter avant ou après) :
...
ТОЧНЫЙ формат (без ответов, ничего не добавлять до или после) :
